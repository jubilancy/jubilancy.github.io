...
* Bitly
* Blickdomi Compact
* ([https://ifttt.com/blink](https://ifttt.com/blink))
* Blink (Europe)\]([https://ifttt.com/blink\_eu](https://ifttt.com/blink_eu))
* blink(1)\]([https://ifttt.com/blink1](https://ifttt.com/blink1))
* Blogger
* Blue by ADT
* Blue Connect
...
* BOSMA
* BotGhost
* Botslab (Asia)\]([https://ifttt.com/Botslab\_Asia](https://ifttt.com/Botslab_Asia))
* Botslab (Europe)\]([https://ifttt.com/Botslab\_Europe](https://ifttt.com/Botslab_Europe))
* Botslab (North America)\]([https://ifttt.com/Botslab\_NorthAmerica](https://ifttt.com/Botslab_NorthAmerica))
* Bouncie
* Boundary
* Box
* Boxcar 2
...
* Dribbble Job Board
* Drip
* ([https://ifttt.com/dropbox](https://ifttt.com/dropbox))
* Duct Tape Marketing
* Dude Perfect
* e-Connect
* EarthOne
...
* Eater
* eBay
* ([https://ifttt.com/ecobee](https://ifttt.com/ecobee))
* Ecosense
* Edutopia on YouTube
...
* EZTECH
* EZVIZ
* ([https://ifttt.com/facebook](https://ifttt.com/facebook))
* Facebook Lead Ads
* \[Facebook Pages\]([https://ifttt.com/facebook\_pages](https://ifttt.com/facebook_pages))
* Family Handyman
* Fanimation
* Fathom
...
* Fing
* Firedesk
* ([https://ifttt.com/fitbit](https://ifttt.com/fitbit))
...
* Fullarm
* FuseBase (Formerly Nimbus Note)\]([https://ifttt.com/nimbus\_note](https://ifttt.com/nimbus_note))
* Futurehome
* FYTA
* Garadget
* Garageio
...
* Giphy
* GitHub
* ([https://ifttt.com/gmail](https://ifttt.com/gmail))
* Gnbly - AI Caller
* GO by Raylogic
* go-e Charger
* Gogogate
...
* \[Google Calendar\]([https://ifttt.com/google\_calendar](https://ifttt.com/google_calendar))
* Google Chat
* \[Google Contacts\]([https://ifttt.com/google\_contacts](https://ifttt.com/google_contacts))
* \[Google Docs\]([https://ifttt.com/google\_docs](https://ifttt.com/google_docs))
* \[Google Drive\]([https://ifttt.com/google\_drive](https://ifttt.com/google_drive))
* Google Forms
* Google Meet
* Google Nest Thermostat
* \[Google Sheets\]([https://ifttt.com/google\_sheets](https://ifttt.com/google_sheets))
* Google Tasks
* Google Wifi
* Govee Home
* GQ
...
* HiDrive
* Histre
* HolaBrain AC (formerly Dollin Smart AC)\]([https://ifttt.com/dollin\_smart\_ac](https://ifttt.com/dollin_smart_ac))
...
* Inspinia Technology
* ([https://ifttt.com/instagram](https://ifttt.com/instagram))
* Instapaper
* INSTAR
* Intellithings
...
* Kwikset Smart Locks
* LaMetric
* Langolink Lock (China)\]([https://ifttt.com/llinklockcn](https://ifttt.com/llinklockcn))
* Lasagna Marketing
* Latwy
* Lektrico Charger
* Lennox iComfort
...
* Money Talks News
* MoneySense
* ([https://ifttt.com/monzo](https://ifttt.com/monzo))
* Moodo & Moodo AIR
* Moonside Light
...
* Otiom
* OVAL
* Overlord - AI accountability partner
* Owl Home
* PackPack AI
* PagerDuty
* Panasonic MirAIe
...
* PewDiePie
* PG&E
* \[Philips Hue\]([https://ifttt.com/hue](https://ifttt.com/hue))
* Phone Call (US only)\]([https://ifttt.com/phone\_call](https://ifttt.com/phone_call))
* Phyn
...
* Powahome
* Powered by Viva
* PowerView® Automation (Legacy)\]([https://ifttt.com/powerview](https://ifttt.com/powerview))
* Product Hunt
* Proscenic
* Pushbullet
* Pushcut
...
* RSS Feed
* RSS Ground
* ([https://ifttt.com/rust](https://ifttt.com/rust))
* RYSE
* SamProof
* SAUTER Cozytouch
* SaveTheProof
...
* SmartHome Washer
* Smarthon IoT (micro:bit)\]([https://ifttt.com/smarthon](https://ifttt.com/smarthon))
* SmartHours™️
...
* Spoki
* SpotCam
* ([https://ifttt.com/spotify](https://ifttt.com/spotify))
* Square
* sRemo
...
* ([https://ifttt.com/todoist](https://ifttt.com/todoist))
* Toggl Track
* Toodledo
* Total Connect 2.0
* TP-Link Kasa
...
* Wear OS
* weara
* \[Weather Underground\]([https://ifttt.com/weather](https://ifttt.com/weather))
...
* WUUK
* Wyze
* X (Twitter)\]([https://ifttt.com/twitter](https://ifttt.com/twitter))
* X-House smart home
* Xtactor
